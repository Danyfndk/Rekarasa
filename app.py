...
with col_graph:
    ...
    if not df_plot.empty:
        # PERBAIKAN BUG UI: Hapus text statis dan gunakan Custom Hover Data untuk tampilan mobile yang bersih
        ...
        # Desain Garis Area Mewah Ala SaaS Analytics
        fig.update_traces(
            line_color="#0D9488", 
            line_width=4, 
            line_shape='spline', 
        ...
        # Penyesuaian Sumbu agar muat cantik di layar HP
        fig.update_layout(
